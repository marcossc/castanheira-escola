...
import com.castanheira.escola.jpa.session.TurmaFacade;
...
public class TurmaBean implements Serializable {
    ...
    @EJB
    private com.castanheira.escola.jpa.session.TurmaFacade ejbFacade;
    ...
    public static class TurmaBeanConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TurmaBean controller = (TurmaBean) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "turmaBean");
