...
import com.castanheira.escola.jpa.session.ProfessorDiscTurFacade;
...
@Named("professorDiscTurController")
@SessionScoped
public class ProfessorDiscTurController implements Serializable {
    ...
    public ProfessorDiscTurController() {
    }
    ...
    private ProfessorDiscTurFacade getFacade() {
        return ejbFacade;
    }
    ...
    public static class ProfessorDiscTurControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ProfessorDiscTurController controller = (ProfessorDiscTurController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "professorDiscTurController");
