...
public class BoletimController implements Serializable {
    ...
    private BoletimFacade getFacade() {
        return ejbFacade;
    }
    ...
    public static class BoletimControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            BoletimController controller = (BoletimController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "boletimController");
