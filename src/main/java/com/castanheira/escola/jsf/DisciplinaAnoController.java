...
@Named("disciplinaAnoController")
@SessionScoped
public class DisciplinaAnoController implements Serializable {
    ...
    private DisciplinaAnoFacade getFacade() {
        return ejbFacade;
    }
    ...
    public static class DisciplinaAnoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            DisciplinaAnoController controller = (DisciplinaAnoController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "disciplinaAnoController");
