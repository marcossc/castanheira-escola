...
@NamedQueries({
    ...
    , @NamedQuery(name = "Boletim.findByIdAluno", query = "SELECT b FROM Boletim b WHERE b.idMatricula.idAluno.id = :idAluno")
...
public class Boletim implements Serializable {
    ...
    @JoinColumn(name = "id_matricula", referencedColumnName = "id", updatable = true)
    @ManyToOne(optional = false)
